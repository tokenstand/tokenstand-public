...
export function useETHPriceManager(): [string, (newETHPrice: string) => void] {
  const ethPriceResult = useAppSelector((state) => state.user.ethPrice);
  const dispatch = useAppDispatch()
  const setETHPrice = useCallback((newETHPrice: string) => {
    dispatch(updateETHPrice({ userETHPrice:  newETHPrice}))
  }, [dispatch])
  return [ethPriceResult, setETHPrice];
}
