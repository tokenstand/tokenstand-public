...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(setChainIdDisconnect, (state, action) => {
      state.chainIdDisconnect = action.payload.chainId;
    })
);
