...
export function useSwitchNetworkModalToggle(): () => void {
  return useToggleModal(ApplicationModal.NETWORK_SWITCH);
}
...
export function useRoutingModalToggle(): () => void {
  return useToggleModal(ApplicationModal.ROUTING_FULL_SCREEN);
}

// export function useToggWithDrawModal(): () => void {
...
export function useChainIdDisconnect(): ChainId {
  return useSelector((state: AppState) => state.application.chainIdDisconnect);
}
