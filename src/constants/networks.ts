...
export const NETWORK_LABEL: { [chainId in ChainId]?: string } =
  process.env.NEXT_PUBLIC_NETWORK === "TESTNET"
    ? { [ChainId.RINKEBY]: "Rinkeby", [ChainId.BSC_TESTNET]: "BSC Testnet", [ChainId.KOVAN]: "Kovan" }
    : { [ChainId.MAINNET]: "Ethereum", [ChainId.BSC]: "BSC", [ChainId.ARBITRUM]: "Arbitrum" };

export const NETWORK_LINK: { [chainId in ChainId]?: String } = {
