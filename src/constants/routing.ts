...
export const COMMON_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [STAND[ChainId.MAINNET], DAI, USDC, USDT, WBTC],
  [ChainId.RINKEBY]: [...WRAPPED_NATIVE_ONLY[ChainId.RINKEBY], STAND[ChainId.RINKEBY]],
  [ChainId.BSC_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC_TESTNET], STAND[ChainId.BSC_TESTNET]],
  [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC, MATIC.WBTC, MATIC.DAI, MATIC.WETH, MATIC.USDT],
  [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH],
  [ChainId.BSC]: [BSC.STAND, BSC.DAI, BSC.USD, BSC.USDC, BSC.USDT, BSC.BTCB, BSC.WETH, BSC.XWIN],
  [ChainId.ARBITRUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITRUM]],
