...
export const USDC = {
  ...
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, '0x8570c3592cceb7ebcd51dc13f3b95fe2f4f01c80', 6, 'USDC', 'USD Coin'),
  [ChainId.BSC_TESTNET]: new Token(ChainId.BSC_TESTNET, '0x9780881bf45b83ee028c4c1de7e0c168df8e9eef', 6, 'USDC', 'USD Coin'),
}
