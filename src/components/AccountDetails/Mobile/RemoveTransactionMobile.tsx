...
const HorizontalBar = styled.div`
  border-bottom: 1px solid ${({ theme }) => theme.borderENSNamePopup};
`;
export default function RemoveTransactionMobile({ removeHistory, ethPrice, dataSource, tableOptions, setTableOptions }) {
